...
unsigned char find_median(unsigned char *test,unsigned char size)
{
	...
	return (med+0.5)  ;      //return equivalent to rounding off the value to nearest integer 
}
...
unsigned char find_mean(unsigned char *test,unsigned char size)
{
	...
	return (mean+0.5);	//return equivalent to rounding off the value to nearest integer
}
